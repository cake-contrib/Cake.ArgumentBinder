...
{
    [TestFixture]
    public class BooleanEnvironmentVariableBindTests
    {
        // ---------------- Fields ----------------
        ...
        private sealed class BooleanBind
        {
            ...
            [BooleanArgument(
                ...
                Required = true,
                ArgumentSource = ArgumentSource.EnvironmentVariable
            )]
        ...
        /// </remarks>
        [TaskName( nameof( BooleanEnvironmentVariableBindTask ) )]
        public class BooleanEnvironmentVariableBindTask : BaseFrostingTask
        {
            ...
            {
                BooleanEnvironmentVariableBindTests.foundException = exception;
